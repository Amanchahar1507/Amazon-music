// THIS IS FEATURESTHISWEEK CARD OR WE SAY HOW IT DISPLAY ON THE SCREEN WE MADE THIS TO DEMO CARD
// FOR THE FEATUREDTHISWEEK..........

import React from 'react';

const FeaturedThisWeekCard = ({ images, name, type }) => {
  return (
...
export default FeaturedThisWeekCard;
